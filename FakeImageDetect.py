...
font = ('times', 18, 'bold')
title = Label(main, text='Fake Image Detection using CNN', justify=LEFT)
title.config(bg='light blue', fg='DarkOrchid1')
